...
def saveLayerToFile(layer, filename): ## QgsVectorFileWriter  has no attriburte writeAsVectorFormatV2
    ...
    error = QgsVectorFileWriter.writeAsVectorFormat(layer, "output/"+filename,
                                                    "CP1250", layer.crs(),
                                                    "ESRI Shapefile")
